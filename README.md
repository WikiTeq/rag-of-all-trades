...
- type: web
  ...
  config:
    ...
    depth: 0                  # optional, BFS levels to follow from seed URLs (default 0)
    same_domain_only: true    # optional, restrict crawl to seed hosts (default true)
    max_pages: 100            # optional, hard cap on total pages crawled
