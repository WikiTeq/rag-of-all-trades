...
class TestWebIngestionInit(unittest.TestCase):
    def test_init_attributes(self):
        job, patches = _make_job(
...
class TestWebIngestionListItemsUrls(unittest.TestCase):
    def test_yields_one_item_per_url(self):
        ...
        job, patches = _make_job(urls=urls)
...
class TestWebIngestionGetDocumentMetadata(unittest.TestCase):
